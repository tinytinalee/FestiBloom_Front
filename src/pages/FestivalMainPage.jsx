    ...
    <div className="festival-main-container">
      <div className="festival-content-box">
        ...
        <nav className="tab-menu">
          <Link to={`/festival/${festivalNo}/notice`}>공지사항</Link>
          <Link to={`/festival/${festivalNo}/review`}>후기 게시판</Link>
          <Link to={`/festival/${festivalNo}/qna`}>Q&A</Link>
          <Link to={`/festival/${festivalNo}/booth`}>부스 안내</Link>
          <Link to={`/festival/${festivalNo}/lineup`}>라인업</Link>
          <Link to={`/festival/${festivalNo}/weather`}>날씨 정보</Link>
        </nav>
